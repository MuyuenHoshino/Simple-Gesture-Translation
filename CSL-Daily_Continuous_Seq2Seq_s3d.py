...
from dataset_new import CSL_Daily_Continuous_TwoStream,CSL_Daily_Continuous_TwoStream_gloss_simple,CSL_Daily_Continuous_TwoStream_gloss,CSL_Daily_Continuous_TwoStream_balanced
...
print("import")
from MMTL import VisualModule
from train_s3d import train_seq2seq_fuse_s3d

# Path setting
data_path = "/root/autodl-tmp/picture_new_128"
...
if __name__ == '__main__':
    ...
    train_set = CSL_Daily_Continuous_TwoStream_gloss(data_path=data_path, pkl_path=pkl_path,
        corpus_path=corpus_path, frames=sample_duration, mode="train",keypoints_path = keypoints_path,transform = transform)
    val_set = CSL_Daily_Continuous_TwoStream_gloss(data_path=data_path, pkl_path=pkl_path,
        corpus_path=corpus_path, frames=sample_duration, mode="val",keypoints_path = keypoints_path,transform = transform)
    test_set = CSL_Daily_Continuous_TwoStream_gloss(data_path=data_path, pkl_path=pkl_path,
    ...
    model = VisualModule(2003, backbone_weights="./S3D_kinetics400.pt")
    #load_path = "/root/autodl-tmp/models/CSL-Daily_TwoStream/CSL-Daily_TwoStream_epoch006.pth"
    ...
    for epoch in range(epochs):
        ...
        train_seq2seq_fuse_s3d(model, criterion, optimizer, clip, train_loader, device, epoch, logger, log_interval, writer, total_dict)
