...
model_path = "/root/autodl-tmp/models/seq2word_models_convLstm"
log_path = "log/cnnlstm_{:%Y-%m-%d_%H-%M-%S}.log".format(datetime.now())
sum_path = "runs/islr_cnnlstm_{:%Y-%m-%d_%H-%M-%S}".format(datetime.now())
...
if __name__ == '__main__':
    ...
    val_loader = DataLoader(val_set, batch_size=batch_size, shuffle=True, num_workers=64, pin_memory=True)
    # Create model
